...
const SelectedMovie = lazy(() =>
  import("@pages/(selected-media)/selected-movie/page")
)
const SelectedSeries = lazy(() =>
  import("@pages/(selected-media)/selected-series/page")
)
const PublicLists = lazy(() => import("@pages/lists/page"))
const PublicList = lazy(() => import("@pages/lists/[share-id]/page"))
const Account = lazy(() => import("@pages/account/page"))
const UserLists = lazy(() => import("@pages/account/lists/page"))
const PrivateList = lazy(() => import("@pages/account/lists/p/page"))
